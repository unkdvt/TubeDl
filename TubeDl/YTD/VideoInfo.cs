...
namespace YoutubeExtractor
{
    public class VideoInfo
    {
        internal static IEnumerable<VideoInfo> Defaults = new List<VideoInfo>
        {
            ...
            new VideoInfo(133, VideoType.Mp4, 240, false, AudioType.Aac, 64, AdaptiveType.Video),
            new VideoInfo(134, VideoType.Mp4, 360, false, AudioType.Aac, 128, AdaptiveType.Video),
            ...
            new VideoInfo(137, VideoType.Mp4, 1080, false, AudioType.Aac, 192, AdaptiveType.Video),
            new VideoInfo(138, VideoType.Mp4, 2160, false, AudioType.Aac, 192, AdaptiveType.Video),
            new VideoInfo(160, VideoType.Mp4, 144, false, AudioType.Aac, 192, AdaptiveType.Video),
            new VideoInfo(264, VideoType.Mp4, 1440, false, AudioType.Aac, 192, AdaptiveType.Video),
             new VideoInfo(298, VideoType.Mp4, 720, false, AudioType.Aac, 192, AdaptiveType.Video, 60),
            new VideoInfo(299, VideoType.Mp4, 1080, false, AudioType.Aac, 192, AdaptiveType.Video, 60),
            new VideoInfo(266, VideoType.Mp4, 2160, false, AudioType.Aac, 192, AdaptiveType.Video),
